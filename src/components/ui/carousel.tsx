      ...
      >
        ...
        >
          ...
          {arrowsPosition === "bottom" ? (
            ...
            // Default: place arrows centered vertically at sides within the Carousel root
            <>
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ref={ref}
      className={cn(
        "h-8 w-8 sm:h-9 sm:w-9 rounded-full liquid-arrow flex items-center justify-center absolute",
        orientation === "horizontal"
